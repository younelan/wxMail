...
StyledTextPanel::StyledTextPanel(wxWindow *parent) : SettingsPanel(parent) {
  wxXmlResource::Get()->LoadPanel(this, parent, "StyledTextPanel");

  m_showFormattingToolbar =
      XRCCTRL(*this, "m_showFormattingToolbar", wxCheckBox);
  m_sendBothPlainStyled =
      XRCCTRL(*this, "m_sendBothPlainStyled", wxRadioButton);
...
void StyledTextPanel::LoadSettings() {
  ...
  m_showFormattingToolbar->SetValue(
      config.ReadBool("/Settings/ShowStyledTextToolbar", true));
  ...
  m_askEachTime->SetValue(
      config.ReadBool("/Settings/WarnQueueStyledText", false));
...
void StyledTextPanel::SaveSettings() {
  ...
  config.Write("/Settings/ShowStyledTextToolbar",
               m_showFormattingToolbar->GetValue());
  config.Write("/Settings/SendPlainAndStyled",
               m_sendBothPlainStyled->GetValue());
